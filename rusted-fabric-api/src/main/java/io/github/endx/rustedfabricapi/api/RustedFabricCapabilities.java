...
public final class RustedFabricCapabilities {
    ...
    public static final String CUSTOM_UNIT_LOAD = "event.custom.unit.load.v1";
    ...
    public static final String PROJECTILE_COMBAT = "event.projectile.combat.v1";
    ...
    private RustedFabricCapabilities() {
    }
}
