...
Java_io_github_endx_rustedfabric_android_xposed_jvm_NativeRenderBridge_nativeAttachSurface(
...
extern "C" JNIEXPORT void JNICALL
Java_io_github_endx_rustedfabric_android_xposed_jvm_NativeRenderBridge_nativeDetachSurface(
        JNIEnv*, jclass) {
    std::lock_guard<std::mutex> lock(window_mutex);
    ANativeWindow* previous = attached_window;
