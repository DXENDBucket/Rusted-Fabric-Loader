...
Java_io_github_endx_rustedfabric_android_launcher_jvm_NativeJvmHost_nativeLaunch(
...
Java_io_github_endx_rustedfabric_android_launcher_jvm_NativeJvmHost_nativeLastError(
        JNIEnv* env, jclass) {
