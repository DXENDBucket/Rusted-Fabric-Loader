...
final class TypedDesktopApiExample {
    private static final ChannelId STATUS_CHANNEL = ChannelId.of("rusted_fabric_example", "status");
    private static final ChannelId MODE_CHANNEL = ChannelId.of("rusted_fabric_example", "mode");
    ...
    private static final JavaUnitAction MARK_POSITION = JavaUnitAction.builder(
            "rusted_fabric_example:mark_position", "Mark position",
    ...
    private static final JavaUnitAction PAID_SIGNAL = JavaUnitAction.builder(
            "rusted_fabric_example:paid_signal", "Paid signal",
    ...
    private static final PersistentDataKey<Integer> START_COUNT = PersistentData.register(
            Identifier.of("rusted_fabric_example", "start_count"), 1,
    ...
    static void register() {
        ...
        Translations.register("rusted_fabric_example", resources);
        ...
        ModResourceReloaders.register("rusted_fabric_example:settings", resources,
                new ModResourceReloader<Properties>() {
                    @Override public Properties prepare(ModResourcePack pack) throws Exception {
                        return pack.resource("assets/rusted_fabric_example/data/example.properties")
                                .readPropertiesUtf8();
                    }
        ...
        EXAMPLE_MODES.register("rusted_fabric_example:status", "status");
        EXAMPLE_MODES.register("rusted_fabric_example:inspection", "inspection");
        ...
        RegistryTagJsonReloader<String> modeTags = RegistryTagReloaders.json(
                EXAMPLE_MODES, "rusted_fabric_example:mode_tags", "rusted_fabric_example");
        ModResourceReloaders.register("rusted_fabric_example:mode_tags", resources, modeTags,
                "rusted_fabric_example:settings");
        GameTickScheduler.schedule("rusted_fabric_example:ready_tick", 1,
        ...
        LanguageEvents.AFTER_RELOAD.register(language -> ExampleMod.log(
                Translations.translate("rusted_fabric_example:language_reloaded", language)));
        ExampleMod.log(Translations.translate(
                "rusted_fabric_example:loader_ready", "Rusted Fabric Example"));

        ChatCommands.register("rusted_fabric_example:status", context -> {
