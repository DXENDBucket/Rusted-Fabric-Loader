...
- Rusted Warfare `1.15`
- Rusted Fabric Loader `0.4.3` / API `0.3.10`
...
shared `rustedWarfare` directory for normal Android file managers and made available to the game
through an Android-only path bridge. Windows and Android then execute the same desktop game,
Fabric runtime, API Jar, Mixins, and
