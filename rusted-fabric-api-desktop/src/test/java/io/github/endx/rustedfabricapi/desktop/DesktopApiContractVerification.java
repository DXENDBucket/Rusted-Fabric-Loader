...
public final class DesktopApiContractVerification {
    private DesktopApiContractVerification() {
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Mapped desktop API contract verification passed");
    }
